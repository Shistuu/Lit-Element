...
export const OVERVIEW_OF_LEAVE_TYPES_AND_PROCESS =
  'Overview of Leave types and process';

export const LEAPFROG = 'Leapfrog';

export const COMPANY_HOLIDAY_NEPAL_2023_24 =
  'Company Holiday (Nepal) || 2023/24';
...
export const ADDITION_OF_TEAM_MEMBERS_TO_GITHUB =
  'Addition of team members to GitHub';

export const GITHUB_ACCESS_MAIL =
  'Mail is to be sent by either Project Manager or Team lead of Vyaguta to IT department to provide access to our GitHub Organization.';
...
export const OVERVIEW_OF_LEAVE_TYPES_AND_PROCESSES =
  'Overview of Leave types and processes';

export const VYAGUTA_BUG_REPORT_JANUARY_2024 =
  'Vyaguta Bug Report of January 2024 based on Bug Categories';

export const LOOP_TOPIC = "We're keeping you in the loop";

export const LOOP_PARAGRAPH =
